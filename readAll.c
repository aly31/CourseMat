...
int main (int argc, char* argv[])
{
  ...
  MPI_File_read_all(fha,&n_global,1,MPI_INT,MPI_STATUS_IGNORE);
  ...
  MPI_File_read_all(fha,v1,counts[my_rank],MPI_DOUBLE,MPI_STATUS_IGNORE);
  MPI_File_read_all(fhb,v2,counts[my_rank],MPI_DOUBLE,MPI_STATUS_IGNORE);
